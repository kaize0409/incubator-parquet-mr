...
//        }
        ...
        throw new ParquetDecodingException(format(
          "Can not read value at %d in block %d in file " + "%s", current, currentBlock, file), e);
      }
    }
    return true;
  }
...
//        }
        ...
        throw new ParquetDecodingException(format("Can not read value at %d in block %d in file "
          + "%s", current, currentBlock, file), e);
      }
    }
    return true;
  }
